  ...
  const data = [
    {
      billID: 1, table: 'A1-1', zone_name: 'โซนบาร์ห้องแอร์', billStatus: 'waiting', time: '20.00', Order_detail: [
        { menuId: 1, quantity: 3, name_menu: 'ข้าวผัดหมู', detail: 'ไม่ผัก', type: 'พิเศษ', menuStatus: 'todo' },
        { menuId: 2, quantity: 3, name_menu: 'ข้าวผัดกุ้ง', detail: 'ไม่ผัก', type: 'พิเศษ', menuStatus: 'todo' },
        { menuId: 3, quantity: 1, name_menu: 'ส้มตำ', detail: 'ไม่ปลาร้า', type: '', menuStatus: 'todo' },
        { menuId: 4, quantity: 2, name_menu: 'ข้าวไข่เจียว', detail: '', type: 'ธรรมดา', menuStatus: 'todo' },
        { menuId: 5, quantity: 1, name_menu: 'ข้าวหมูทอด', detail: '', type: 'พิเศษ', menuStatus: 'todo' },
        { menuId: 5, quantity: 1, name_menu: 'ข้าวหมูทอด', detail: '', type: 'พิเศษ', menuStatus: 'todo' },
      ]
    },
    {
    ...
    },
    {
      billID: 2, table: 'A1-2', zone_name: 'โซนบาร์ห้องแอร์', billStatus: 'waiting', time: '22.00', Order_detail: [
        { menuId: 1, quantity: 3, name_menu: 'ข้าวต้ม', detail: '', type: 'พิเศษ', menuStatus: 'todo' },
        { menuId: 2, quantity: 3, name_menu: 'ข้าวไข่เจียว', detail: '', type: 'ธรรมดา', menuStatus: 'todo' },
      ]
    },
    {
                ...
                {Order_detail.map((item, index) => (
                  <div key={index} >
                    <div className='grid grid-cols-2'>
                      <div className='flex gap-3'> <BiSolidCheckbox className="text-[#ED7E46]" />{item.name_menu}
                      </div>
